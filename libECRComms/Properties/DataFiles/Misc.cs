...
{
    class MiscDataFactory
    {
        public static MiscData Get(MachineIDs id)
        {
            switch (id)
            {
                case MachineIDs.ER230:
                case MachineIDs.ER380M_UK:
                    return new MiscData1();
    ...
    public abstract class MiscData : data_serialisation
    {
    ...
    public class MiscData1 : MiscData
    {
        public MiscData1()
        {
