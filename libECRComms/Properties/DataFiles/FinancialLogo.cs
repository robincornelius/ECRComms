...
{
    class FinancialLogoDataFactory
    {
        public static FinancialLogoData Get(MachineIDs id)
        {
            switch (id)
            {
                case MachineIDs.ER230:
                case MachineIDs.ER380M_UK:
                    return new FinancialLogoData1();
    ...
    public abstract class FinancialLogoData : data_serialisation
    {

        public FinancialLogoData()
        {
    ...
    public class FinancialLogoData1 : FinancialLogoData
    {
        public FinancialLogoData1()
        {
